...
def generate_token() -> Tuple:
    ...
    return (public_jwk, dataset_encoded, empty_encoded, passport_terms_encoded, passport_dataset1_encoded)
...
async def userinfo(request: web.Request) -> web.Response:
    ...
    if request.headers.get("Authorization").split(" ")[1] == DATA[2]:
        ...
        print("ga4gh token requested")
        data = {"ga4gh_passport_v1": [DATA[3], DATA[4]]}
    return web.json_response(data)
